namespace YorkshireDigital.Data.Helpers
{
    ...
    public interface IDiscourseHelper
    {
        ...
        object GetRedirectUrl(string discourseDomain, string name, string externalId, string email, string username, string nonce);
    }
    ...
    public class DiscourseHelper : IDiscourseHelper
    {
        ...
        public object GetRedirectUrl(string discourseDomain, string name, string externalId, string email, string username, string nonce)
        {
