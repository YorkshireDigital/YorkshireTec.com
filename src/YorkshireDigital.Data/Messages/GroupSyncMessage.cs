...
namespace YorkshireDigital.Data.Messages
{
    public class GroupSyncMessage : IHandleMessage
    {
        ...
        public GroupSyncMessage(string groupId, IGroupService groupService, IMeetupService meetupService, IEventService eventService, IUserService userService, IHangfireService hangfireService)
        {
            GroupId = groupId;
